...
\doxysubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsection{Descripción detallada}
Functions that manage interrupts and exceptions via the NVIC. 
...
\doxysubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsection{Documentación de «define»}
...
\doxysubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsubsection{Documentación de funciones}
...
Reads Debug Authentication Status register. \begin{DoxyReturn}{Devuelve}
...
returns the MVE type \begin{DoxyReturn}{Devuelve}
...
\end{DoxyNote}
\input{dc/d86/group___c_m_s_i_s___core___fpu_functions}
